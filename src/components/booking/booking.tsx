...
const serverActions = async ({inputValue, start, end, targetHour}:IServerActionsProps) => {
    ...
    const addEvent = await fetch ('https://bookmytime-node.azurewebsites.net/createevent', {
        method: 'POST',
    ...
    if (responseAddEvent === "OK") {
        ...
        const sendMail = await fetch ('https://bookmytime-node.azurewebsites.net/sendmail', {
            method: 'POST',
            headers: {'Content-Type': 'application/json;charset=utf-8'},
        ...
        fetch ('https://bookmytime-node.azurewebsites.net/sendmail', {
            method: 'POST',
            headers: {'Content-Type': 'application/json;charset=utf-8'},
